...
document.addEventListener("DOMContentLoaded", () => {
    ...
    async function fetchUserData() {
        ...
        try {
            ...
            if (response.ok && result.exists) {
                ...
                console.log("✅ FETCH SUCCESS! Personal profile loaded.");
    ...
    async function openDetailsModal(id, isTV) {
        try {
            ...
            communityShareBtn.onclick = () => {
                shareMovieToCommunity(currentModalData);
            };
            ...
            if (isTV) {
                ...
                validSeasons.forEach(s => {
                    ...
                    if (parseInt(s.season_number) === parseInt(resumeSeason)) {
